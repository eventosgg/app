Template.adminExhibitionTripsAdd.onCreated(function() {
  Session.set('exhibitionsErrors', {});
});

Template.adminExhibitionTripsAdd.helpers({
...
Template.adminExhibitionTripsAdd.events({
  'submit form': function(e) {
    ...
    Meteor.call('addTrip',this.exhibition,trip,function(err,res) {
      swal.close();
